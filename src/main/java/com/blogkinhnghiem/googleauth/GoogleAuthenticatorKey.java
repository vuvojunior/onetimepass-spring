...
public final class GoogleAuthenticatorKey
{
    ...
    /**
     * Returns the URL of a Google-provided QR barcode to be loaded into the Google Authenticator application. The user
     * scans this bar code with the application on their smart phones or manually enter the secret manually.
     *
     ...
     * @return the URL of a Google-provided QR barcode to be loaded into the Google Authenticator application.

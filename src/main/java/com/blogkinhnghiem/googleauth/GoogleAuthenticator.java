...
public class GoogleAuthenticator implements IGoogleAuthenticator
{
    ...
    /**
     * The number of bits of a secret key in binary form. Since the Base32 encoding with 8 bit characters introduces an
     * 160% overhead, we just need 80 bits (10 bytes) to generate a 16 bytes Base32-encoded secret key.
     */
    private static final int SECRET_BITS = 80;

    /**
     * Number of scratch codes to generate during the key generation. We are using Google's default of providing 5
     * scratch codes.
     */
    ...
    /**
     * Length in bytes of each scratch code. We're using Google's default of using 4 bytes per scratch code.
     */
    ...
    /**
     * Cryptographic hash function used to calculate the HMAC (Hash-based Message Authentication Code). This
     * implementation uses the SHA1 hash function.
     */
    ...
    /**
     * The internal SecureRandom instance used by this class. Since as of Java 7 Random instances are required to be
     * thread-safe, no synchronisation is required in the methods of this class using this instance. Thread-safety of
     * this class was a de-facto standard in previous versions of Java so that it is expected to work correctly in
     * previous versions of the Java platform as well.
     */
    ...
    /**
     * Calculates the verification code of the provided key at the specified instant of time using the algorithm
     ...
     * instant of time for the given secret key.
     *
    ...
    /**
     * This method calculates a scratch code from a random byte buffer of suitable size
    ...
    /**
     * This method creates a new random byte buffer from which a new scratch code is generated. This function is invoked
     * if a scratch code generated from the main buffer is invalid because it does not satisfy the scratch code
     * restrictions.
     *
    ...
    /**
     * This method loads the first available and valid ICredentialRepository registered using the Java service loader
     * API.
     *
     * @return the first registered ICredentialRepository.
     * @throws UnsupportedOperationException if no valid service is found.
     */
     ...
     *
     * @return the first registered ICredentialRepository or <code>null</code> if none is found.
     */
